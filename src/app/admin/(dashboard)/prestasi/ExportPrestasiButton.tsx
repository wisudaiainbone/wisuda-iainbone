...
export default function ExportPrestasiButton({ data, overrides, periode }: Props) {
  ...
  return (
    <button
      ...
      title="Export XLSX"
      className="flex items-center justify-center w-10 sm:w-32 gap-1.5 px-3 sm:px-4 h-10 rounded-lg sm:rounded-xl bg-emerald-600 hover:bg-emerald-700 text-white text-xs sm:text-sm font-normal sm:font-semibold transition-colors shadow-sm shadow-emerald-900/20 disabled:opacity-50 disabled:cursor-not-allowed whitespace-nowrap"
    >
