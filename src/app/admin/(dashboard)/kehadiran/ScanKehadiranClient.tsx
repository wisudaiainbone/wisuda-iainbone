          ...
          <div className="flex flex-col items-center gap-3">
            <div className="flex items-center justify-center gap-2">
              ...
              <button
                ...
                className="flex items-center justify-center gap-2 px-4 py-3.5 bg-emerald-600 hover:bg-emerald-700 active:bg-emerald-800 text-white rounded-2xl font-bold shadow-xl text-sm transition-all active:scale-95"
                title="Scan"
              >
                <Camera size={16} />
