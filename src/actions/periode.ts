    ...
    const customId = `${year}-${randomPart}`;
      ...
      const { data: inserted, error } = await supabase
        ...
        .insert({
          ...
          waktu_sesi_1: waktu_sesi_1 ?? data.session1 ?? null,
          waktu_sesi_2: waktu_sesi_2 ?? data.session2 ?? null,
          jadwal_gladi: jadwal_gladi ?? data.gladi ?? null,
          pengumuman: pengumuman ?? data.pengumuman ?? null,
  ...
  try {
    ...
    const { error } = await supabase
      ...
      .update({ 
        ...
        waktu_sesi_1: waktu_sesi_1 ?? updates.session1 ?? null,
        waktu_sesi_2: waktu_sesi_2 ?? updates.session2 ?? null,
        jadwal_gladi: jadwal_gladi ?? updates.gladi ?? null,
        pengumuman: pengumuman ?? updates.pengumuman ?? null,
